...
<body bgcolor="#778899" >
<h2 align = 'center'>GDS PNR Creation</h2><button value='Reset all' onClick ='onLoadFields();' class='back-to-top'>Reset All</button>
<%
String pos = request.getParameter("hiddenPOS")!=null?	request.getParameter("hiddenPOS").toString():"";
String currCD = request.getParameter("hiddenCurr")!=null?	request.getParameter("hiddenCurr").toString():"";
if(pos.length()>0)	
CommonProperties.pos=pos;
if(currCD.length()>0)
CommonProperties.currency=currCD;
out.println("<h3 align = 'center'><b>POS: </b>" +CommonProperties.pos+ " | Currency: "+CommonProperties.currency+"</h3>");
%>
<h4>Enter/Select the below required details for creating GDS PNR</h4>
<%
		out.println("<div id='lblHeader'><h2 align='center'>Generating GDS PNR..... </h2> </div>");
...
//Deleted from Form tag
	...
	out.println("<td><input type='button' value='Change POS' onClick ='posDisp();'></td>");
